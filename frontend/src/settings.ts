        ...
        <section class="settings-section" id="section-api-keys">
          ...
          <div class="mono-row setup-hide">
            <div class="mono-row-text">
              <div class="mono-row-title">Push-to-talk</div>
              <div class="mono-row-sub">Hold <strong id="ptt-key-label">⌥</strong> to skip the wake word</div>
            </div>
            <label class="mono-switch"><input type="checkbox" id="input-push-to-talk" /><span class="mono-slider"></span></label>
          </div>
