"""
VALET Proactive Suggestions — Contextual follow-up suggestions after task completion.
...
log = logging.getLogger("valet.suggestions")
...
class Suggestion:
    ...
    text: str  # Voice-friendly suggestion (VALET personality)
