...
Click the page once to enable audio, then speak. VALET will respond.
...
4. VALET detects intent -- conversation, action, or build request
...
7. Fish Audio converts the response to speech with the VALET voice
