"""
VALET Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so VALET always knows what he's working on,
...
log = logging.getLogger("valet.dispatch")
